...
> **Compatibility note:** This page keeps the legacy route `/en/api/types-and-views` reachable after the Pages IA overhaul.
>
> **Canonical destination:** [Reference / Types and Views](/en/reference/types-and-views)
