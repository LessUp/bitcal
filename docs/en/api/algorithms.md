...
> **Compatibility note:** This page keeps the legacy route `/en/api/algorithms` reachable after the Pages IA overhaul.
>
> **Canonical destination:** [Reference / Algorithm Contract](/en/reference/algorithms)
