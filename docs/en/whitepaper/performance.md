...
If you expected design reasoning, return to the [Whitepaper landing](/en/whitepaper/index). The whitepaper remains the place for architecture arguments; the performance section is where evidence is published and limited.
