...
hero:
  name: BitCal Docs
  text: Documentation overview / 文档总览
  tagline: Docs landing for audience routing, language entry, and the retained Guide / Whitepaper / Performance / Reference / Research / Status model.
  actions:
    - theme: brand
      text: English home
      link: /en/
...
This page is the shared documentation overview for BitCal. Use it to choose language, route different audiences, and enter the maintained Guide / Whitepaper / Performance / Reference / Research / Status structure without going through legacy aliases.
