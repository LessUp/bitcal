...
BITCAL_TEST_CASE(test_block_view_smoke) {
...
BITCAL_TEST_CASE(test_algorithm_smoke) {
...
BITCAL_TEST_CASE(test_is_zero_query) {
    bitcal::bit_block<256> block;
...
BITCAL_TEST_CASE(test_popcount_counts_bits_across_words) {
    bitcal::bit_block<256> block;
    auto view = block.view();
...
BITCAL_TEST_CASE(test_and_into_writes_preallocated_output) {
    bitcal::bit_block<256> lhs;
    bitcal::bit_block<256> rhs;
...
BITCAL_TEST_CASE(test_or_into_writes_preallocated_output) {
    bitcal::bit_block<256> lhs;
    bitcal::bit_block<256> rhs;
    bitcal::bit_block<256> out;
...
BITCAL_TEST_CASE(test_xor_into_writes_preallocated_output) {
    bitcal::bit_block<256> lhs;
    bitcal::bit_block<256> rhs;
    bitcal::bit_block<256> out;
...
BITCAL_TEST_CASE(test_andnot_into_writes_preallocated_output) {
    bitcal::bit_block<256> lhs;
    bitcal::bit_block<256> rhs;
    bitcal::bit_block<256> out;
...
BITCAL_TEST_CASE(test_bit_or_combines_words_256) {
    bitcal::bit_block<256> lhs;
    bitcal::bit_block<256> rhs;
...
BITCAL_TEST_CASE(test_bit_xor_combines_words_256) {
    bitcal::bit_block<256> lhs;
    bitcal::bit_block<256> rhs;
...
BITCAL_TEST_CASE(test_bit_andnot_masks_words_256) {
    bitcal::bit_block<256> lhs;
    bitcal::bit_block<256> rhs;
...
BITCAL_TEST_CASE(test_block_storage_alignment) {
    bitcal::bit_block<256> block;
...
BITCAL_TEST_CASE(test_block_word_span_interop) {
...
BITCAL_TEST_CASE(test_block_copy_words_to_supports_self_copy) {
...
BITCAL_TEST_CASE(test_bit_and_matches_deterministic_matrix_128) {
...
BITCAL_TEST_CASE(test_bit_or_matches_deterministic_matrix_128) {
...
BITCAL_TEST_CASE(test_bit_xor_matches_deterministic_matrix_128) {
...
BITCAL_TEST_CASE(test_bit_andnot_matches_deterministic_matrix_128) {
...
BITCAL_TEST_CASE(test_popcount_matches_deterministic_matrix_256) {
...
BITCAL_TEST_CASE(test_bit_and_matches_deterministic_matrix_512) {
...
BITCAL_TEST_CASE(test_is_zero_detects_sparse_and_dense_patterns_192) {
...
BITCAL_TEST_CASE(test_view_word_count_matches_custom_width_192) {
...
BITCAL_TEST_CASE(test_equals_reports_equal_and_not_equal_192) {
...
BITCAL_TEST_CASE(test_equals_returns_false_for_mismatched_view_lengths) {
...
BITCAL_TEST_CASE(test_block_uses_optimal_alignment_per_width) {
...
BITCAL_TEST_CASE(test_shift_left_moves_bits_across_words_128) {
...
BITCAL_TEST_CASE(test_shift_left_clears_when_count_reaches_width_128) {
...
BITCAL_TEST_CASE(test_shift_right_moves_bits_across_words_128) {
...
BITCAL_TEST_CASE(test_shift_preserves_single_bit_at_width_minus_one_128) {
    const std::array<std::uint64_t, 2> input_words{1ULL, 0ULL};
    const auto block = bitcal::bit_block<128>::from_words(input_words);
...
BITCAL_TEST_CASE(test_shift_clears_when_count_exceeds_width_128) {
...
BITCAL_TEST_CASE(test_shift_handles_size_max_count_256) {
...
BITCAL_TEST_CASE(test_shift_zero_is_noop_256) {
...
BITCAL_TEST_CASE(test_shift_bit_shift_extremes_128) {
...
BITCAL_TEST_CASE(test_shift_word_boundary_no_bit_shift_128) {
...
BITCAL_TEST_CASE(test_random_bit_and_matches_reference_model_256) {
...
BITCAL_TEST_CASE(test_random_queries_match_reference_model_512) {
...
BITCAL_TEST_CASE(test_equals_avx2_path_256_and_512) {
...
BITCAL_TEST_CASE(test_random_equals_matches_reference_model_256) {
...
BITCAL_TEST_CASE(test_random_bit_or_matches_reference_model_256) {
...
BITCAL_TEST_CASE(test_random_bit_xor_matches_reference_model_256) {
...
BITCAL_TEST_CASE(test_random_bit_andnot_matches_reference_model_256) {
...
BITCAL_TEST_CASE(test_bit_block_64_basic_ops) {
...
BITCAL_TEST_CASE(test_public_contract_all_retained_algorithms_are_accessible) {
...
BITCAL_TEST_CASE(test_block_overload_matches_span_form) {
...
BITCAL_TEST_CASE(test_ctad_bit_block_overload_runtime) {
...
BITCAL_TEST_CASE(test_random_shift_left_matches_reference_model_256) {
...
BITCAL_TEST_CASE(test_random_shift_right_matches_reference_model_256) {
...
BITCAL_TEST_CASE(test_random_shift_left_matches_reference_model_512) {
...
BITCAL_TEST_CASE(test_random_shift_right_matches_reference_model_512) {
