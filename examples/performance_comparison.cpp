...
int main() {
    ...
    std::cout << "64位操作:" << std::endl;
    {
        ...
        benchmark("bit64 AND", [&]() { do_not_optimize(a & b); }, iterations);

        benchmark("bit64 XOR", [&]() { do_not_optimize(a ^ b); }, iterations);

        benchmark("bit64 ANDNOT", [&]() { do_not_optimize(a.andnot(b)); }, iterations);
        ...
        benchmark("bit64 popcount", [&]() { do_not_optimize(a.popcount()); }, iterations);
    }
    ...
    std::cout << std::endl << "128位操作:" << std::endl;
    {
        ...
        benchmark("bit128 AND", [&]() { do_not_optimize(a & b); }, iterations);

        benchmark("bit128 XOR", [&]() { do_not_optimize(a ^ b); }, iterations);

        benchmark("bit128 ANDNOT", [&]() { do_not_optimize(a.andnot(b)); }, iterations);
        ...
        benchmark("bit128 popcount", [&]() { do_not_optimize(a.popcount()); }, iterations);
    }
    ...
    std::cout << std::endl << "256位操作:" << std::endl;
    {
        ...
        benchmark("bit256 AND", [&]() { do_not_optimize(a & b); }, iterations);

        benchmark("bit256 XOR", [&]() { do_not_optimize(a ^ b); }, iterations);

        benchmark("bit256 ANDNOT", [&]() { do_not_optimize(a.andnot(b)); }, iterations);
        ...
        benchmark("bit256 popcount", [&]() { do_not_optimize(a.popcount()); }, iterations);
    }
    ...
    std::cout << std::endl << "512位操作:" << std::endl;
    {
        ...
        benchmark("bit512 AND", [&]() { do_not_optimize(a & b); }, iterations);

        benchmark("bit512 XOR", [&]() { do_not_optimize(a ^ b); }, iterations);

        benchmark("bit512 ANDNOT", [&]() { do_not_optimize(a.andnot(b)); }, iterations);
        ...
        benchmark("bit512 popcount", [&]() { do_not_optimize(a.popcount()); }, iterations);
    }
