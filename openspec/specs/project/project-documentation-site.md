# Project Spec: Documentation and Site

## Overview

This spec defines BitCal's canonical documentation sources, GitHub Pages information architecture, and bilingual maintenance boundaries.
...
BitCal SHALL structure its GitHub Pages experience so that project promotion, quick-start guidance, deep reference material, and archival or maintenance context are clearly separated.
